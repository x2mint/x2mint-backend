...
router.get("/", verifyToken, async(req, res) => {
    ...
    // #swagger.summary = 'Get all questions by admin/creator'
...
router.get("/:questionId", verifyToken, async(req, res) => {
    // #swagger.tags = ['questions']
    // #swagger.security = [{ "bearerAuth": [] }] 
    // #swagger.summary = 'Get question by id'
...
router.post("/new/:testId", verifyToken, async(req, res) => {
    // #swagger.tags = ['questions']
    // #swagger.security = [{ "bearerAuth": [] }] 
    // #swagger.summary = 'Create a question by admin/creator'
...
router.put("/:questionId", verifyToken, async(req, res) => {
    // #swagger.tags = ['questions']
    // #swagger.security = [{ "bearerAuth": [] }] 
    // #swagger.summary = 'Update a question by admin/creator'
...
router.put("/:questionId/delete", verifyToken, async(req, res) => {
    // #swagger.tags = ['questions']
    // #swagger.security = [{ "bearerAuth": [] }] 
    // #swagger.summary = 'Delete a question by id by admin/creator'
...
router.get("/:questionId/answers", verifyToken, async(req, res) => {
    // #swagger.tags = ['questions']
    // #swagger.security = [{ "bearerAuth": [] }] 
    // #swagger.summary = 'Get all answers by question id'
