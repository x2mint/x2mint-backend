...
router.post("/register", async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.summary = 'Endpoint for register user'
    ...
    try {
        ...
        const activation_token = jwt.sign({ newUser },
            process.env.REACT_APP_ACTIVATION_TOKEN_SECRET, { expiresIn: '5m' }
        );
...
router.post("/activation", async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.summary = 'Endpoint for activate email'
...
router.post("/forgotPassword", async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.summary = 'Endpoint for forgot password'
    ...
    try {
        ...
        const access_token = jwt.sign({ id: user._id },
            process.env.REACT_APP_ACCESS_TOKEN_SECRET, { expiresIn: '5m' }
        );
...
router.post("/resetPassword", async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.summary = 'Endpoint for reset password'
...
router.post("/login", async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.summary = 'Endpoint for login user by username and password'
...
router.get("/getInfor", async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.summary = 'Endpoint for get information user'
...
router.post("/loginViaGoogle", async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.summary = 'Endpoint for login via google'
...
router.post("/login/google", verifyToken, async(req, res, next) => {
    ...
    // #swagger.summary = 'Endpoint for login with google api'
...
router.get("/verify", verifyToken, async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.security = [{ "bearerAuth": [] }] 
    // #swagger.summary = 'Endpoint for verify token'
...
router.get("/", verifyToken, async(req, res) => {
    // #swagger.tags = ['auths']
    // #swagger.security = [{ "bearerAuth": [] }] 
    // #swagger.summary = 'Endpoint for get user information by token'
